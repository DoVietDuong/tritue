...
url = "C:\\Users\\ADMIN\\Desktop\\trituenhantao\\baitap4\\dautay.jpeg"
img = io.imread(url)
...
print(f"Mã màu gần với màu đỏ nhất: Color Segment {closest_color_index}: {closest_color}")
...
for top_left, bottom_right in filtered_rectangles:
    cv2.rectangle(img_ori, top_left, bottom_right, (0, 0, 255), thickness=2)
